local options = {
    function(weather) ExecuteCommand('setweather ' .. weather) end, -- Заменено на qbx_gametime
    function(time) ExecuteCommand('settime ' .. time .. ' 0') end, -- Заменено на qbx_gametime
    function()
