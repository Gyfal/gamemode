return {
    ...
    player = {
        ...
        -- Привилегированные группы которые не теряют голод/жажду
        privilegedGroups = { 'god', 'admin' }, -- Группы, у которых не уменьшается голод/жажда
        useAcePerms = true, -- Использовать ACE разрешения вместо групп
        acePermission = 'qbx.admin', -- ACE разрешение для отключения голода/жажды
